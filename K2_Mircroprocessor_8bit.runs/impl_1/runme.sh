...
HD_PWD='/home/it/K2_Mircroprocessor_8bit/K2_Mircroprocessor_8bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_K2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_K2.tcl -notrace
